<%@ Page Title="Edit Product - CozaStore Admin" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Edit_Products.aspx.cs" Inherits="Ecom_Project.Admin.Edit_Products" %>
        ...
        <div class="col-xl-8 col-lg-10">
            <div class="card-premium">
                <div class="card-header-premium">
                    <div class="ch-title">
                        <span class="ch-icon si-green"><i class="fa-solid fa-pen-to-square"></i></span>
                ...
                <div class="card-body-premium">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="Product_name" runat="server" ReadOnly="True" CssClass="form-control-premium" placeholder="e.g. Classic Denim Shirt"></asp:TextBox>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="Category_name" ReadOnly="True" runat="server" CssClass="form-control-premium" placeholder="Category name"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Current Product Image Showcase -->
                    <div class="form-group">
                        ...
                        <div class="current-image-card">
                            ...
                            <div>
                                <span style="font-size:13px; font-weight:600; color:var(--text-primary); display:block;">Active Product Image</span>
                                <span style="font-size:11px; color:var(--text-muted); display:block;">This image is currently active in the store catalog.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload-wrap">
                            ...
                            <asp:FileUpload ID="Product_image" runat="server" ClientIDMode="Static" style="position:absolute;inset:0;opacity:0;cursor:pointer;width:100%;height:100%;" />
                        </div>
                        ...
                        <!-- Client-side Live Upload Preview -->
